...
\end{homework}
\begin{homework}[7]
    设$\mat{A}$是$\R$上$m\times n$的列满秩矩阵,其中$m>n$.记$\mat{A}$的列空间为$U$, 记
    \[\mat{P}_{\mat{A}}=\mat{A}(\mat{A}^\t\mat{A})^{-1}\mat{A}^\t\]
    令$\mathcal{P}_{\mat{A}}(\mat{X})=\mat{P}_{\mat{A}}\mat{X}$对所有$\mat{X}\in\R^m$成立.
    \begin{enumerate}
        \item 证明: $\mat{P}_{\mat{A}}\mat{X}\in U$.
        \item 证明: $\mathcal{P}_{\mat{A}}$是$\R^m$到$U$的正交投影.
    \end{enumerate}
\end{homework}
\end{document}